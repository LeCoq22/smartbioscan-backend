...
def _build_data(analysis: dict, doctor_name: str = '') -> dict:
    ...
    return {
        ...
        'tbw_pct':            act['act_pct'],
        'tbw_pct_min':        act['act_pct_range'][0],
        'tbw_pct_max':        act['act_pct_range'][1],
        'tbw_pct_label':      act['act_pct_cat'],
        'tbw_kg_min':         act['act_kg_range'][0],
        'tbw_kg_max':         act['act_kg_range'][1],
        'tbw_kg_label':       act['act_kg_cat'],
        'muscle_mass_kg':     m.muscle_mass_kg,
        'smm_kg':             muscle['mme_kg'],
        'smm_kg_min':         muscle['mme_range'][0],
        'smm_kg_max':         muscle['mme_range'][1],
        ...
        'muscle_arm_l_cat':   sm['left_arm']['quality_cat'],
        'muscle_arm_l_kgcat': sm['left_arm']['kg_cat'],
        'muscle_arm_r_kg':    sm['right_arm']['kg'],
        'muscle_arm_r_pct':   sm['right_arm']['pct_ideal'],
        'muscle_arm_r_score': int(sm['right_arm']['quality']),
        'muscle_arm_r_cat':   sm['right_arm']['quality_cat'],
        'muscle_arm_r_kgcat': sm['right_arm']['kg_cat'],
        'muscle_leg_l_kg':    sm['left_leg']['kg'],
        'muscle_leg_l_pct':   sm['left_leg']['pct_ideal'],
        'muscle_leg_l_score': int(sm['left_leg']['quality']),
        'muscle_leg_l_cat':   sm['left_leg']['quality_cat'],
        'muscle_leg_l_kgcat': sm['left_leg']['kg_cat'],
        'muscle_leg_r_kg':    sm['right_leg']['kg'],
        'muscle_leg_r_pct':   sm['right_leg']['pct_ideal'],
        'muscle_leg_r_score': int(sm['right_leg']['quality']),
        'muscle_leg_r_cat':   sm['right_leg']['quality_cat'],
        'muscle_leg_r_kgcat': sm['right_leg']['kg_cat'],
        'muscle_quality_total': muscle['mq_total'],
        'muscle_quality_label': muscle['mq_total_cat'],
        # Rango de calidad muscular segmentaria por edad/sexo (Tanita)
        'mq_ref_min':         muscle['leg_score_normal'][0],
        'mq_ref_max':         muscle['leg_score_normal'][1],
        'leg_score_cat':      muscle['leg_score_cat'],
        # Balance & leg score
        'balance_arm_pct':    balance['arm_diff_pct'],
        'balance_leg_pct':    balance['leg_diff_pct'],
        'leg_score':          muscle['leg_score'],
        'leg_score_expected': muscle['leg_score_expected'],
        'leg_score_diff_pct': muscle['leg_score_diff_pct'],
        # Water compartments
        'ecw_l':              act['aec_l'],
        'icw_l':              act['aic_l'],
